...
let currentUserName = 'Emaan'; // yahan apna naam/number rakh sakte ho
...
function populateMySenderSelect(messages) {
  ...
  // Agar currentUserName pehle se set hai aur list me exist karta hai, usko preserve karo
  if (currentUserName && senders.includes(currentUserName)) {
    mySenderSelect.value = currentUserName;
    return;
  }

  // Auto detect only if obvious value mil jaye

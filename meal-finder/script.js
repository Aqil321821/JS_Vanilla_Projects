...
// Function to fetch default meals for "Today's Menu"
function loadTodaysMenu() {
  resultHeading.innerHTML = `<h2>Today's Menu</h2>`;

  const mealPromises = [];
  for (let i = 0; i < 16; i++) {
    mealPromises.push(fetch(`https://www.themealdb.com/api/json/v1/1/random.php`).then((res) => res.json()));
  }
